...
You have a nice mic chain setup, somewhere. Maybe it lives in OBS, maybe in a DAW, maybe you've just collected a few good VST plugins over the years. The problem is it only works in that one place.
...
- Windows 10+ (tested), likely works on Windows 8+ with WASAPI. Wont work on Windows 7.
